...
<div class="container-fluid px-4">
	<h1 class="mt-4">Exam Schedule Details</h1>
                    ...
                    foreach($exam_result as $row)
                    {
                        ...
                        else
                        {
                            if(time() > strtotime($end_time))
                            {
                                ...
                                if(is_null($exam_result_datetime))
                                {
                                    $action_button = '';
                                }
                                else
...
<video id="video" style="width: 200px; height: 200px; float: right;  margin-right:40px ;" autoplay></video>
<?php
include('footer.php');
?>
