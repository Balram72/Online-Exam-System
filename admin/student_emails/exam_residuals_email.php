...
$rand = rand(0000,1111);
                           if ($email) {
                                  $update_status_query = "UPDATE student_soes SET student_status ='Enable',student_email_verification_code = '$rand' WHERE student_email_id = '$email'";
          ...
          if($student_email_id){
           try {
            ...
            $mail->isHTML(true);
            $mail->CharSet = 'UTF-8';
            $mail->Subject = 'Reminder email | ' . $student_roll_no . ' | Examination Organization.';
            $mail->Body = '
                <html lang="en">
                <head>
                    <meta charset="UTF-8">
