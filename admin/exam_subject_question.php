...
<div class="container-fluid px-4">
	<h1 class="mt-4">Exam Subject Question Management</h1>
	<ol class="breadcrumb mb-4">
        <li class="breadcrumb-item"><a href="dashboard.php">Dashboard</a></li>
        <li class="breadcrumb-item active">Exam Subject Question List</li>
    </ol>
      		...
      		<div class="modal-content">
        		...
        		<div class="modal-body">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <select name="exam_subject_id" id="exam_subject_id" class="form-select" required>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-12">
                                <textarea name="exam_subject_question_title"  id="exam_subject_question_title" class="form-control datepicker" required  data-parsley-trigger="keyup" ></textarea>
                        </div>
                    </div>
                    <div class="mb-3 row">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-9">
                            <select name="exam_subject_question_answer" id="exam_subject_question_answer" class="form-select" required>
...
<script>
   ...
   CKEDITOR.replace('exam_subject_question_title', {
        ...
        height: 100, // Height is set in pixels
        startupFocus: true, // Cursor will start at the beginning of the line
        entities: false, // Prevents CKEditor from converting entities like &nbsp;
        basicEntities: false, // Prevents CKEditor from adding <br> tags and other entities
        enterMode: CKEDITOR.ENTER_P, // Sets the default enter mode to <p> instead of <br>
        shiftEnterMode: CKEDITOR.ENTER_P, // Sets the shift-enter mode to <p> instead of <br>
        autoParagraph: true // Ensures content is wrapped in <p> tags
    });
...
$(document).ready(function(){
	...
	$('#exam_subject_question_form').on('submit', function(event){
		...
		{		
            ...
            formData += '&exam_subject_question_title=' + encodeURIComponent(CKEDITOR.instances.exam_subject_question_title.getData());    
