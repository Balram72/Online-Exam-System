...
if(isset($_POST["action"]))
{
	if($_POST["action"] == 'fetch')
	{
		...
		{
			$sub_array = array();
		  // $sub_array[] = '<input type="checkbox" class="student_checkbox" data-email="'.$row["student_email_id"].'">';
...
// 			$sub_array[] = $status;
			...
			<button type="button" name="edit_button" class="btn btn-warning btn-circle btn-sm edit_button" data-id="'.$row["student_id"].'"><i class="fas fa-edit"></i></button>
				<button type="button" name="delete_button" class="btn btn-danger btn-circle btn-sm delete_button" data-id="'.$row["student_id"].'"><i class="fas fa-trash fa-fw"></i></button>
			</div>
			';
			$data[] = $sub_array;
		}
	...
	if($_POST["action"] == 'Add')
	{
		...
		else
		{
			...
			$data = array(
				...
				':student_email_verification_code'	=>	'',
			...
			(student_name, student_address, student_email_id, student_password, student_gender, student_dob, student_image, student_status, student_email_verification_code, student_email_verified, student_added_by, student_added_on) 
			VALUES (:student_name, :student_address, :student_email_id, :student_password, :student_gender, :student_dob, :student_image, :student_status, :student_email_verification_code, :student_email_verified, :student_added_by, :student_added_on)
			";
