...
class Soes
{
	public $base_url = 'http://localhost/MVDO/Online-Exam-System/';
	public $connect;
	public $query;
	public $statement;
	public $now;
	...
	function send_email($receiver_email, $subject, $body)
	{
		...
		$mail->Host = ''; //Define your Email Host Name

		$mail->Port = '587';

		$mail->SMTPAuth = true;

		$mail->Username = ''; //Define your Email Username

		$mail->Password = ''; //Define your Email Password
	...
	function Get_total_result()
	{
		...
		SELECT COUNT(exam_id) as Total 
		FROM exam_soes 
		WHERE exam_result_datetime IS NOT NULL
		";
		$result = $this->get_result();
		foreach($result as $row)
		{
