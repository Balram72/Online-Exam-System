    	...
    	<form method="post" id="exam_form">
      		<div class="modal-content">
        		...
        		<div class="modal-body">
                    ...
                    <div class="mb-3">
                        <label>Class</label>
                        <select name="exam_class_id" id="exam_class_id" class="form-select" required>
                    ...
                    <div class="mb-3">
                        ...
                        <select name="exam_duration" id="exam_duration" class="form-select" required>
	...
	$(document).on('click', '.edit_button', function(){
		...
		$.ajax({
	      	...
	      	success:function(data)
	      	{
                ...
                exam_status_html += '<select name="exam_status" id="exam_status" class="form-select">';
