                ...
                else
                {
                	if(time() > $exam_last_subject_end_datetime)
                	{
	                    ...
	                    $status = '<span class="badge bg-dark">Completed</span>';
	                            //   $action_button = '<button type="button" name="publish_result" class="btn btn-primary btn-sm publish_result" data-exam_id="'.$row["exam_id"].'">Publish Result</button> &nbsp;&nbsp;
								// 			<a href="result_publish_email.php?exam_id='.$row["exam_id"].'" class="btn btn-info btn-sm text-white">Send Email</a>&nbsp;&nbsp;
								// 			<a href="exam_result.php?ec='.$row["exam_code"].'" class="btn btn-secondary btn-sm">View Result</a>
								// 			';
								
						 $action_button = '<a href="exam_result.php?ec='.$row["exam_code"].'" class="btn btn-secondary btn-sm">View Result</a>';		
	                }
	                else
	                {
