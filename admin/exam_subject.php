...
<div class="container-fluid px-4">
	<h1 class="mt-4">Exam Subject Management</h1>
	<ol class="breadcrumb mb-4">
        <li class="breadcrumb-item"><a href="dashboard.php">Dashboard</a></li>
        <li class="breadcrumb-item active">Exam Subject List</li>
    </ol>
      		...
      		<div class="modal-content">
        		...
        		<div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="datetime-local" name="subject_exam_datetime" id="subject_exam_datetime" class="form-control datepicker" required data-parsley-trigger="keyup" />
                    </div>
                    <div class="mb-3">
                        <label>Total Question</label>
                        <select name="subject_total_question" id="subject_total_question" class="form-select" required>
                    ...
                    <div class="mb-3">
                        ...
                        <select name="marks_per_right_answer" id="marks_per_right_answer" class="form-select">
                            <option value="">Select</option>
                    ...
                    <div class="mb-3">
                        ...
                        <select name="marks_per_wrong_answer" id="marks_per_wrong_answer" class="form-select">
                            <option value="">Select</option>
