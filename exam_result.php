...
if(isset($_GET['ec']))
{
	...
	foreach($student_data as $student_row)
	{
		...
		$student_profile_img = $object->base_url . 'images/' . $student_row["student_image"];
	...
	foreach($result as $row)
	{
		...
		$object->query = "
        SELECT SUM(exam_subject_question_answer.marks) AS total 
        FROM exam_subject_question_answer 
        ...
        WHERE exam_subject_question_soes.exam_subject_id = '".$exam_subject_id."' 
